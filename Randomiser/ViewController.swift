...
class ViewController: UIViewController {
    ...
    let firstDict = ["опасный", "сложный", "необычный", "продуктивный", "выматывающий"]
    let secondDict = ["удивит", "разочарует", "ободрит"]
    let bigDict = [
        ...
        "Если решитесь на незапланированное путешествие, то сможете получить множество незнакомых ощущений.",
        ...
        "Вам предоставится возможность вложить душу в каждое, сделанное вами дело.",
        ...
        "Избавитесь от зависти злых людей, если поставите в церкви 12 свечек во здравие.",
        ...
        "Интуиция станет вашей супер силой и многое сделает для вас. Слушайтесь её.",
        ...
        "Цены на бензин перестанут вас беспокоить, если вы пересядете в «Феррари».",
    ...
    @IBOutlet weak var countTittle: UILabel!
    ...
    override func viewDidLoad() {
        ...
        //Button decor
        buttonOutlet.setTitle("Узнай свою судьбу!", for: .normal)
        buttonOutlet.backgroundColor = .systemGreen
        buttonOutlet.setTitleColor(.white, for: .normal)
        buttonOutlet.setTitleColor(.black, for: .highlighted)
        buttonOutlet.layer.cornerRadius = 7
        buttonOutlet.layer.borderWidth = 1
        
        countTittle.isHidden = true
        countTittle.text = "До следующего предсказания:"
    ...
    @IBAction func pushButton(_ sender: UIButton) {
        ...
        let randomInt3 = Int.random(in: 0...363)
        //Data output
        //labelOutlet.text = "\(firstDict[randomInt1]) и \(secondDict[randomInt2])"
        labelOutlet.text = "\(bigDict[randomInt3])"
        buttonOutlet.isEnabled = false
        countTittle.isHidden = false
        self.buttonOutlet.setTitle("time", for: .normal)
        self.buttonOutlet.backgroundColor = .cyan
        
        //Add timer
        DispatchQueue.main.asyncAfter(deadline: .now() + 1) {
            self.buttonOutlet.isEnabled = true
            self.buttonOutlet.backgroundColor = .systemGreen
            self.countTittle.isHidden = true
            self.buttonOutlet.setTitle("Узнай свою судьбу!", for: .normal)
        }
    }
}
